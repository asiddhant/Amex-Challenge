...
Centaurmodel=train(actual_vote~.,
                   data=CentaurtrainDataset[,-c(1,2,32,34,35,41:50,56:116,8:17,36:40)],
                   method="gbm",
                   metric="evalc",
                   #tuneGrid=tgrid,
                   trControl=tctrl
...
Centaurmodelv2=train(actual_vote~.,
                     data=CentaurtrainDatasetv2[,-c(1,2,32,34,35,41:50,56:116,8:17,36:40)],
                     method="gbm",
                     metric="evalc",
                     #tuneGrid=tgrid,
                     trControl=tctrl
...
Cosmosmodel=train(actual_vote~.,
                  data=CosmostrainDataset[,-c(1,2,32,34,35,41:50,56:116,8:17,36:40)],
                  method="gbm",
                  metric="evalc",
                  #tuneGrid=tgrid,
                  trControl=tctrl
...
Cosmosmodelv2=train(actual_vote~.,
                    data=CosmostrainDatasetv2[,-c(1,2,32,34,35,41:50,56:116,8:17,36:40)],
                    method="gbm",
                    metric="evalc",
                    #tuneGrid=tgrid,
                    trControl=tctrl
...
Ebonymodel=train(actual_vote~.,
                 data=EbonytrainDataset[,-c(1,2,32,34,35,41:50,56:116,8:17,36:40)],
                 method="gbm",
                 metric="evalc",
                 #tuneGrid=tgrid,
                 trControl=tctrl
...
Ebonymodelv2=train(actual_vote~.,
                   data=EbonytrainDatasetv2[,-c(1,2,32,34,35,41:50,56:116,8:17,36:40)],
                   method="gbm",
                   metric="evalc",
                   #tuneGrid=tgrid,
                   trControl=tctrl
...
Odysseymodel=train(actual_vote~.,
                   data=OdysseytrainDataset[,-c(1,2,32,34,35,41:50,56:116,8:17,36:40)],
                   method="gbm",
                   metric="evalc",
                   #tuneGrid=tgrid,
                   trControl=tctrl
...
Odysseymodelv2=train(actual_vote~.,
                     data=OdysseytrainDatasetv2[,-c(1,2,32,34,35,41:50,56:116,8:17,36:40)],
                     method="gbm",
                     metric="evalc",
                     #tuneGrid=tgrid,
                     trControl=tctrl
...
Tokugawamodel=train(actual_vote~.,
                    data=TokugawatrainDataset[,-c(1,2,32,34,35,41:50,56:116,8:17,36:40)],
                    method="gbm",
                    metric="evalc",
                    #tuneGrid=tgrid,
                    trControl=tctrl
...
Tokugawamodelv2=train(actual_vote~.,
                      data=TokugawatrainDatasetv2[,-c(1,2,32,34,35,41:50,56:116,8:17,36:40)],
                      method="gbm",
                      metric="evalc",
                      #tuneGrid=tgrid,
                      trControl=tctrl
...
write.csv(nfinalresponse,"response_final2.csv",row.names = FALSE)
write.csv(nlbresponse,"response_lb2.csv",row.names = FALSE)

write.table(nfinalDataset[,c(1,122)],"faceless_men_IIT_Guwahati_final2.csv",sep=",",row.names = FALSE,col.names = FALSE)
write.table(nlbDataset[,c(1,122)],"faceless_men_IIT_Guwahati_lb2.csv",sep=",",row.names = FALSE,col.names = FALSE)